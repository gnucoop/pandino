...
class CompletionResponse:
    def __init__(
        self, error: str = None, answer: str = None, vectors: List[dict] = None
    ):
        self.error = error
        self.answer = answer
...
def complete_chat(
    ...
    messages = [
        {
            "role": "system",
            "content": """You are Dino, an assistant who helps users by answering questions concisely.
...
def reply_to_prompt(prompt: str, username: str, llm_type: str, model: str) -> str:
    messages = [
        {
            "role": "system",
            "content": """Sei un esperto di enti non-profit e devi realizzare il rapporto annuale della tua organizzazione.
